...
public class FindInBoxRange : TargetDesignation<RaycastHit2D[]>
{
    ...
    public override RaycastHit2D[] Execute(SkillSupportData supportData)
    {
        DrawDebugBox(supportData.Pos + (Vector3)m_offsetRangePerTick[supportData.TickCount].normalized, m_boxRangePerTick[supportData.TickCount], 3);
    ...
    void DrawDebugBox(Vector3 center, Vector3 size, float duration)
    {
        // 사각형의 네 꼭짓점 좌표 계산.
