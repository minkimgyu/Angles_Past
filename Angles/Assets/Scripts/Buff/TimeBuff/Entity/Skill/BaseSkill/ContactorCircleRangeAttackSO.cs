...
[System.Serializable]
[CreateAssetMenu(fileName = "ContactorCircleRangeAttackSO", menuName = "Scriptable Object/SkillSO/ContactorCircleRangeAttackSO")]
public class ContactorCircleRangeAttackSO : BaseSkillSO
{
    [SerializeField]
    ...
    {
        return new ContactorCircleRangeAttack(name, useConditionType, overlapType, canFinish, useCount, isFix, duration, tickCount, preDelay, targetFindRange,
